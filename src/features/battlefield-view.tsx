    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="relative overflow-hidden rounded-[28px] border border-esport-accent/20 bg-[linear-gradient(180deg,rgba(11,18,34,0.34),rgba(4,8,18,0.42))] px-6 py-7 shadow-[0_18px_60px_rgba(0,0,0,0.28)] backdrop-blur-xl">
        <div className="pointer-events-none absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(3,10,22,0.82)_0%,rgba(3,10,22,0.72)_30%,rgba(3,10,22,0.46)_44%,rgba(3,10,22,0.08)_66%,rgba(3,10,22,0)_100%)]" />
        </div>
      ...
      <div className="space-y-6">
          {!activeLobby && showJoiningLobbyState && (
            <div className="overflow-hidden rounded-[30px] border border-esport-accent/25 bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.09),transparent_45%),linear-gradient(180deg,rgba(17,24,39,0.14),rgba(2,6,23,0.22))] p-7 shadow-[0_18px_60px_rgba(0,0,0,0.18)] backdrop-blur-xl transition-all duration-300">
              <div className="rounded-3xl border border-esport-accent/30 bg-[linear-gradient(180deg,rgba(255,255,255,0.035),rgba(255,255,255,0.015))] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-xl">
          ...
          {!activeLobby && !showJoiningLobbyState && (
            <div className="overflow-hidden rounded-[30px] border border-esport-accent/20 bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.1),transparent_34%),linear-gradient(180deg,rgba(17,24,39,0.12),rgba(2,6,23,0.2))] p-6 space-y-5 shadow-[0_24px_80px_rgba(0,0,0,0.18)] backdrop-blur-xl transition-all duration-300">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                ...
                <div className="grid grid-cols-3 gap-3 text-left">
                  <div className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] px-4 py-3 backdrop-blur-xl">
                  ...
                  <div className="rounded-2xl border border-esport-accent/20 bg-[linear-gradient(180deg,rgba(59,130,246,0.14),rgba(59,130,246,0.06))] px-4 py-3 backdrop-blur-xl">
              ...
              <div className="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]">
                <div className="space-y-4">
                  <label className="block rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.012))] p-4 backdrop-blur-xl">
                    <div className="text-[10px] font-bold uppercase tracking-[0.22em] text-esport-text-muted">Lobby Name</div>
                    <input value={formState.name} onChange={(e) => setFormState((current) => ({ ...current, name: e.target.value }))} className="mt-3 w-full bg-white/[0.045] border border-esport-border rounded-xl px-3 py-3 text-sm focus:outline-none focus:border-esport-accent/60 backdrop-blur-xl" placeholder="Lobby name" />
                  </label>

                  <div className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.012))] p-4 backdrop-blur-xl">
                        ...
                        return (
                          <button
                            ...
                            className={`rounded-2xl border px-4 py-3 text-left transition ${isActive
                              ? "border-esport-accent bg-esport-accent/[0.16] shadow-[0_0_24px_rgba(59,130,246,0.14)]"
                              : "border-white/10 bg-white/[0.045] hover:border-esport-accent/35 hover:bg-esport-accent/[0.06]"
                              }`}
                          >
                      ...
                      {getGameModeOptions(formState.teamSize).map((mode) => {
                        ...
                        return (
                          <button
                            ...
                            className={`rounded-2xl border px-4 py-3 text-left transition ${isActive
                              ? "border-emerald-400/45 bg-emerald-400/[0.12] shadow-[0_0_18px_rgba(16,185,129,0.12)]"
                              : "border-white/10 bg-white/[0.045] hover:border-emerald-300/30 hover:bg-emerald-400/[0.06]"
                              }`}
                          >
                ...
                <div className="space-y-4">
                        ...
                        return (
                          <button
                            ...
                            className={`rounded-xl border px-3 py-3 text-left transition ${isActive
                              ? "border-esport-accent bg-esport-accent/[0.16] shadow-[0_0_18px_rgba(59,130,246,0.14)]"
                              : "border-white/10 bg-white/[0.045] hover:border-esport-accent/30 hover:bg-esport-accent/[0.06]"
                              }`}
                          >
                  ...
                  <div className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.012))] p-4 backdrop-blur-xl">
                    ...
                    <input type="password" value={formState.password} onChange={(e) => setFormState((current) => ({ ...current, password: e.target.value }))} className="mt-3 w-full bg-white/[0.045] border border-esport-border rounded-xl px-3 py-3 text-sm focus:outline-none focus:border-esport-accent/60 backdrop-blur-xl" placeholder="Optional password" />
          ...
          {activeLobby && (
            <div className="overflow-hidden rounded-[30px] border border-esport-accent/20 bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.1),transparent_32%),linear-gradient(180deg,rgba(17,24,39,0.12),rgba(2,6,23,0.22))] p-5 space-y-5 shadow-[0_24px_80px_rgba(0,0,0,0.18)] backdrop-blur-xl transition-all duration-300">
              <div className="flex flex-col lg:flex-row justify-between gap-4">
                ...
                <div className="rounded-xl border border-esport-border bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.012))] px-4 py-3 min-w-[220px] backdrop-blur-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-xl"><div className="text-[10px] uppercase tracking-[0.2em] text-esport-text-muted">Lobby status</div><div className="mt-2 text-sm font-bold text-white">{activeMatch ? activeMatch.status : activeLobby.status}</div></div>
                <div className="rounded-2xl border border-emerald-300/15 bg-[linear-gradient(180deg,rgba(16,185,129,0.12),rgba(16,185,129,0.04))] p-4 shadow-[0_0_25px_rgba(16,185,129,0.05)] backdrop-blur-xl"><div className="text-[10px] uppercase tracking-[0.2em] text-esport-text-muted">Ready players</div><div className="mt-2 text-sm font-bold text-esport-success">{readyCount}/{activeMembers.length}</div></div>
                <div className="rounded-2xl border border-esport-accent/20 bg-[linear-gradient(180deg,rgba(59,130,246,0.14),rgba(59,130,246,0.05))] p-4 shadow-[0_0_25px_rgba(59,130,246,0.06)] backdrop-blur-xl"><div className="text-[10px] uppercase tracking-[0.2em] text-esport-text-muted">Stake Amount</div><div className="mt-2 text-sm font-bold text-white">{`${Number(activeLobby.stake_amount || 0).toFixed(2)} USDT / player`}</div></div>
              </div>
              ...
              <div className="rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.012))] p-4 backdrop-blur-xl">
                  ...
                  <div className={cn(
                    ...
                    activeLobby?.auto_veto_starts_at
                      ? "border-esport-accent/35 bg-esport-accent/10 text-white"
                        : "border-white/10 bg-white/[0.035] text-esport-text-muted"
                  )}>
                    {activeLobby?.auto_veto_starts_at
              ...
              <div className="space-y-4">
                <div className="rounded-[24px] border border-esport-border bg-[linear-gradient(180deg,rgba(255,255,255,0.035),rgba(255,255,255,0.015))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-xl">
                  ...
                  <div className="h-52 rounded-lg border border-white/10 bg-white/[0.03] p-3 overflow-y-auto space-y-2 backdrop-blur-xl">
                  ...
                  <div className="mt-3 flex gap-2">
                    <input value={chatDraft} onChange={(e) => setChatDraft(e.target.value)} onKeyDown={(e) => { if (e.key === "Enter") { e.preventDefault(); void handleSendMessage(); } }} className="flex-1 bg-white/[0.035] border border-esport-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-esport-accent/60 backdrop-blur-xl" placeholder="Type a message..." />
                ...
                {(activeVoteSession || activeLobby.map_voting_active || activeLobby.auto_veto_starts_at) && (
                  <div className="rounded-[24px] border border-esport-border bg-[linear-gradient(180deg,rgba(255,255,255,0.035),rgba(255,255,255,0.015))] p-4 space-y-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] backdrop-blur-xl">
                    <div className="flex items-center justify-between gap-3">
                    ...
                    {activeVoteSession ? (
                      <>
                        <div className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.012))] px-4 py-4 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between backdrop-blur-xl">
                          <div className="flex items-center gap-2">
                        ...
                        <div className="overflow-x-auto custom-scrollbar pb-2">
                          ...
                          <div className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.012))] px-4 py-5 text-sm text-esport-text-muted backdrop-blur-xl">
          ...
          <div className="overflow-hidden rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(17,24,39,0.12),rgba(2,6,23,0.2))] p-5 shadow-[0_18px_60px_rgba(0,0,0,0.16)] backdrop-blur-xl transition-all duration-300">
