-- 20260416_0054_quick_queue_game_mode_party_regression_fix.sql
-- Restore party-aware quick queue entry expansion after 0053 added game_mode support.
-- 0053 regressed party queue matching by only upserting the calling user instead of the
-- full accepted party, which leaves two 2-player parties stuck at 2/4 forever.
