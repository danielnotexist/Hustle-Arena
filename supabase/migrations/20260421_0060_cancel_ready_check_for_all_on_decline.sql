-- 20260421_0060_cancel_ready_check_for_all_on_decline.sql
-- If any player declines a quick-queue ready check, cancel it for the entire
-- roster. Re-queueing should only happen when the host explicitly starts a new
-- search, otherwise party members can be silently reinserted and clients drift.
